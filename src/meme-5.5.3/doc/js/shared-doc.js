...
var shared_doc = {
  ...
  "all-pgc-desc": [
    "Show actual sequence coordinates for motif sites in the output if the FASTA ",
    "IDs of the sequences include coordinates in an <a href=\'fasta-coordinates-format.html\'> accepted format</a>. ",
    "When this option is specified, each input sequence FASTA header is ",
    "checked for UCSC-style genomic coordinates (e.g., <code>chr1:156887119-156887619</code>) or ",
    "Galaxy 'Fetch sequence'-style coordinates (e.g., <code>>mm9_chr18_75759530_7575972_-</code>). ",
    "The strand (if given) is ignored."
  ],
  "all-pgc-def": [
    "The first position in the sequence is assumed to be position 1."
  ],
