...
public class Memechip extends SubmitJob<Memechip.Data> {
  ...
  protected class Data extends SubmitJob.JobData {
    ...
    public void outputJson(JsonWr out) throws IOException {
      ...
      out.property("stremeOptAlign", stremeOptAlign);
    ...
    public String cmd() {
      ...
      if (sequences instanceof LociDataSource) {
        addArgs(args, "-bedfile-pos");
        addArgs(args, "-genome-pos", ((LociDataSource)sequences).getGenomeFileName());
      }
      if (negSeq instanceof LociDataSource) {
        addArgs(args, "-bedfile-neg");
        addArgs(args, "-genome-neg", ((LociDataSource)negSeq).getGenomeFileName());
      }
      if (alphabet != null) {
      ...
      if (stremeOptAlign != null) addArgs(args, "-streme-align", stremeOptAlign);
  ...
  protected Data checkParameters(FeedbackHandler feedback,
    ...
    // Align
    data.stremeOptAlign = paramChoice(request, "streme_align", "left", "center", "right");
