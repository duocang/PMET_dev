...
#	findstr+='='
if findstr[-1]!=':':
	sys.stderr.write('WARNING: The field string does not end with a colon sign. This might be correct, depending on the GFF3 file, but double check your results')
